...
class ContextConfig:
    ...
    sources: Dict[str, str] = field(default_factory=dict)  # {source_id: inclusion_level}
    notes: Dict[str, str] = field(default_factory=dict)  # {note_id: inclusion_level}
...
async def build_mixed_context(
    ...
    # Configure sources
    if source_ids:
        sources_dict: Dict[str, str] = {sid: "insights" for sid in source_ids}
        context_config.sources = sources_dict

    # Configure notes
    if note_ids:
        notes_dict: Dict[str, str] = {nid: "full content" for nid in note_ids}
        context_config.notes = notes_dict
